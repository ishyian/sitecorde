...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <aside
            className="bg-white lg:w-80 lg:min-h-screen lg:border-r border-slate-200 p-4 shrink-0 no-print flex flex-col">
            <div className="flex-1">
              ...
              <span className="font-semibold text-slate-700">
                {viewingAsUser?.name ?? "All Projects"}
                        ...
                        {isUserMenuOpen && (
                            <div
                                className="absolute top-full right-0 mt-2 w-full bg-white rounded-md shadow-lg z-20 border border-slate-200 py-1">
                                <button
                                    onClick={() => {
